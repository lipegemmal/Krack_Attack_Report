...
\begin{abstract}
	This paper references the study of Krack Attack and its correlated components with the objective of completing the Computer Networks 2 graduation course at UFG.
\end{abstract}

\begin{resumo} 
	Esse artigo aborda o estudo do Krack Attack e seus componentes correlatos com o objetivo de completar o curso de graduação da UFG de Redes de Computadores 2.
\end{resumo}
